...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30482 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30482(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_30487 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_30487(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_30497 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_30497(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_30507 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_30507(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30510 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30510(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30516 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30516(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__30478,callback){
var map__30479 = p__30478;
var map__30479__$1 = cljs.core.__destructure_map(map__30479);
var input = map__30479__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30479__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30479__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
