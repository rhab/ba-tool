...
return fetch([cljs.core.str.cljs$core$IFn$_invoke$arity$1(gadget.inspector._STAR_remote_inspector_STAR_),"/clients"].join(''),({"method": "POST", "mode": "cors", "headers": ({"content-type": "application/json"}), "body": JSON.stringify(({"userAgent": navigator.userAgent, "host": location.host}))})).then((function (p1__39176_SHARP_){
return p1__39176_SHARP_.json();
})).then((function (p1__39177_SHARP_){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(p1__39177_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
})).then((function (p__39178){
var map__39179 = p__39178;
var map__39179__$1 = cljs.core.__destructure_map(map__39179);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39179__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
